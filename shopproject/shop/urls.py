...
urlpatterns = [
    ...
    path('cms/shippments/',
         ShippmentListView.as_view(), name='shippment-list'),
    path('cms/shippments/add/',
         ShippmentCreateView.as_view(), name='shippment-create'),
    path('cms/shippments/<int:pk>/',
         ShippmentDetailView.as_view(), name='shippment-detail'),
    path('cms/shippments/update/<int:pk>/',
         ShippmentUpdateView.as_view(), name='shippment-update'),
    path('cms/shippments/delete/<int:pk>/',
         ShippmentDeleteView.as_view(), name='shippment-delete'),
